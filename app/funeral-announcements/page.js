...
export default function FuneralAnnouncementsPage() {
  ...
  async function createAnnouncement() {
    ...
    if (!user) {
      setMessage("Please login to create a funeral announcement.");
      return;
    }
    ...
    setMessage("Funeral announcement created successfully.");
  ...
  if (loading) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-stone-50">
        <p className="text-stone-500">Loading funeral announcements...</p>
      </main>
    );
  }
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-10">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-stone-500">
            Share respectful funeral, memorial service, burial, and family
            gathering information connected to a loved one’s memorial.
          </p>
        </div>
        ...
        <section className="mb-12 rounded-3xl border border-stone-100 bg-white p-7 shadow-sm">
          ...
          <p className="mb-7 text-sm leading-relaxed text-stone-500">
            Add clear service details so family, friends, and the community can
          ...
          {!user && (
            <div className="mb-6 rounded-2xl bg-stone-50 p-4 text-sm text-stone-600">
              ...
              to create a funeral announcement.
            </div>
          )}
